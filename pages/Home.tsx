        ...
        if (envStats) {
          try {
            ...
            if (Array.isArray(parsedStats)) {
              loadedStats = { 'UMUM': parsedStats, 'MA': parsedStats, 'SMA': parsedStats, 'SMP': parsedStats, 'SD': parsedStats, 'TK': parsedStats, 'KAMPUS': parsedStats, 'STAI': parsedStats, 'MI': parsedStats, 'MTS': parsedStats, 'SMPT': parsedStats };
            }
          } catch (e) {
