...
const NewsDetail: React.FC = () => {
    ...
    const authorName = news.author || ('Redaksi ' + (news.jenjang || 'MI Al-Hidayah'));
    const unitName = news.fakultas || news.jenjang || 'MI Al-Hidayah';

    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: news.title || 'Berita MI Al-Hidayah',
